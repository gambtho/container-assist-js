/**
 * Server Status Handler - TypeScript Implementation
...
const ServerStatusOutput = z.object({
  ...
  dependencies: z.object({
    ...
    dockerClient: z.boolean(),
    kubernetesService: z.boolean(),
    mcpSampler: z.boolean(),
...
// Type aliases
export type ServerStatusInputType = z.infer<typeof ServerStatusInput>
export type ServerStatusOutputType = z.infer<typeof ServerStatusOutput>
...
function checkDependencyHealth(context: ToolContext): {
  ...
  return {
    ...
    dockerClient: !!context.dockerClient,
    kubernetesService: false, // Kubernetes service not yet implemented
    mcpSampler: !!context.mcpSampler,
 ...
 */
export const serverStatusHandler: ToolHandler<ServerStatusInputType, ServerStatusOutputType> = {
  name: 'server_status',
  ...
  async execute(input: ServerStatusInputType, context: ToolContext): Promise<Result<ServerStatusOutputType>> {
