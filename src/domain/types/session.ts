...
import { z } from 'zod'
import { DockerfileFixSchema, DockerBuildResultSchema, DockerScanResultSchema, DockerTagResultSchema, DockerPushResultSchema } from './docker.js'
...
export const WorkflowStateSchema = z.object({
  ...
  registry_config: z.object({
    url: z.string(),
    credentials: z.string().optional(),
  }).optional(),

  // Dockerfile fix history
  dockerfile_fix_history: z.array(z.object({
    error: z.string(),
...
export const SessionSchema = z.object({
  ...
  status: z.enum(['active', 'pending', 'analyzing', 'building', 'deploying', 'completed', 'failed', 'expired']).default('active'),
...
export type { DockerBuildResult, DockerScanResult as ScanResult } from './docker.js'
