...
export const TOOL_MANIFEST: Record<string, ToolManifestEntry> = {
  ...
  generate_k8s_manifests: {
    ...
    requiredServices: ['filesystem'],
    implementationPath: 'generate-k8s-manifests/index.ts'
  },
  ...
  prepare_cluster: {
    ...
    status: ToolStatus.IMPLEMENTED,
    category: 'kubernetes',
    description: 'Prepares Kubernetes cluster for deployment',
    requiredServices: ['kubernetes'],
    dependencies: ['generate_k8s_manifests'],
    implementationPath: 'prepare-cluster/prepare-cluster.ts'
  },
  ...
  ping: {
    ...
    status: ToolStatus.IMPLEMENTED,
    category: 'utility',
    description: 'Tests MCP server connectivity and health',
    requiredServices: [],
  ...
  server_status: {
    ...
    requiredServices: [],
    implementationPath: 'ops/server-status.ts'
  }
};
