/**
 * Simplified Tool Configuration for Dependency Injection
 * Focuses on what we need for the new pattern
 */
...
/**
 * Get simple tool configuration by name
 */
export function getSimpleToolConfig(toolName: string): SimpleToolConfig {
  const configs: Record<string, SimpleToolConfig> = {
    // Analysis tools
    analyze_repository: {
