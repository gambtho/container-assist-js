...
import TypeScriptFixer from './fix-patterns-library';
...
async function main() {
  ...
  try {
    ...
    execSync(`git stash push -m "${stashMessage}"`, { stdio: 'pipe', cwd: process.cwd() });
...
function showHelp() {
  console.log(`
${COLORS.BOLD}${COLORS.CYAN}TypeScript Syntax Quick Fix${COLORS.RESET}
